...
pub fn short_probe_barrier_fwd(loc: Coord, dir: Dir, probe_dist: u32, grid: &Grid) -> f32 {
...
pub fn short_probe_barrier_lr(loc: Coord, dir: Dir, probe_dist: u32, grid: &Grid) -> f32 {
